...
smidge = 0.02
sides_to_regular_polygon = 3

x_and_y = [(cos(smidge + 2*i*math.pi/sides_to_regular_polygon),
            sin(smidge + 2*i*math.pi/sides_to_regular_polygon)) for i in range(sides_to_regular_polygon)]
